...
int no_puedo_insertar_lista_nula() {
  ...
  pa2m_afirmar(!lista,
               "No puedo insertar un elemento al final en una lista nula");
  return 0;
}
...
int inserto_elemento_ultima_posicion_lista_no_vacia() {
  ...
  pa2m_afirmar(lista_ultimo(lista) == &numero_2,
               "El elemento se inserto en la ultima posicion con la lista no "
               "vacia vacia");
...
int quitar_elemento_posicion_dada() {
  ...
  pa2m_afirmar(lista_tamanio(lista) == 3,
               "Se disminuyo en uno el tamaño de la lista al remover el "
               "elemento de la posicion");
