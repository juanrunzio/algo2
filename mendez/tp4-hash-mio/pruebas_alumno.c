...
void creacion_de_hash() {
  ...
  pa2m_afirmar(hash_cantidad(hash_1) == 0,
               "La cantidad de elementos se inicializo correctamente en 0, con "
               "el parametro 1");
  pa2m_afirmar(hash_cantidad(hash_2) == 0,
               "La cantidad de elementos se inicializo correctamente en 0, con "
               "el parametro 5");
...
void inserto_10_elementos_10_veces_un_total_de_100_elementos() {
  ...
  nuevo_hash =
      hash_insertar(nuevo_hash, "c", "otro_valor_diferente", &anterior);
...
void elimino_elementos() {
  ...
  pa2m_afirmar(resultado == NULL, "No encuentra el elemento, retorna NULL");
  pa2m_afirmar(hash_cantidad(nuevo_hash) == 9,
...
void contiene_elementos() {
  ...
  pa2m_afirmar(resultado == true, "Retorna true al encontrar el elemento");
  pa2m_afirmar(hash_cantidad(nuevo_hash) == 10,
               "La cantidad de elementos sigue siendo la misma");

  resultado = hash_contiene(nuevo_hash, "w");
  pa2m_afirmar(resultado == false, "No encuentra el elemento, retorna false");
  pa2m_afirmar(hash_cantidad(nuevo_hash) == 10,
               "La cantidad de elementos sigue siendo la misma");

  resultado = hash_contiene(nuevo_hash, "f");
  pa2m_afirmar(resultado == true, "Encuentra otro elemento y retorna true");
...
int main() {
  ...
  pa2m_nuevo_grupo("3_Pruebas de insercion de claves no repetidas en el hash");
  insercion_en_hash();
  pa2m_nuevo_grupo("4_Pruebas de insercion de claves repetidas en el hash");
  reemplazo_en_hash();
  ...
  obtengo_elementos();
  pa2m_nuevo_grupo("8_Pruebas de ver si contiene a un elementos en el hash");
  contiene_elementos();
  pa2m_nuevo_grupo("\n======================== XXX ========================");
