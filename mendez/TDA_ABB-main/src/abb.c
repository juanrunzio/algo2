...
nodo_abb_t *insertar_elemento_comparando(abb_t *arbol, nodo_abb_t *nodo_actual,
					 void *elemento)
{
	if (!nodo_actual) {
	...
	if (comparacion > 0)
		nodo_actual->derecha = insertar_elemento_comparando(
			arbol, nodo_actual->derecha, elemento);

	if (comparacion <= 0)
		nodo_actual->izquierda = insertar_elemento_comparando(
...
abb_t *abb_insertar(abb_t *arbol, void *elemento)
{
	if (!arbol)
		return NULL;
	arbol->nodo_raiz =
		insertar_elemento_comparando(arbol, arbol->nodo_raiz, elemento);
	return arbol;
}
...
nodo_abb_t *quitar_elemento_comparando(abb_t *arbol, nodo_abb_t *nodo_actual,
				       void *elemento,
				       void **elemento_encontrado)
{
	...
	if (comparacion > 0)
		nodo_actual->derecha = quitar_elemento_comparando(
			arbol, nodo_actual->derecha, elemento,
			elemento_encontrado);
	if (comparacion < 0)
		nodo_actual->izquierda = quitar_elemento_comparando(
			arbol, nodo_actual->izquierda, elemento,
			elemento_encontrado);
...
void *abb_quitar(abb_t *arbol, void *elemento)
{
	...
	arbol->nodo_raiz = quitar_elemento_comparando(
		arbol, arbol->nodo_raiz, elemento, &elemento_encontrado);
	return elemento_encontrado;
}

void *buscar_elemento_comparando(abb_t *arbol, nodo_abb_t *nodo_actual,
				 void *elemento)
{
	if (!nodo_actual)
		return NULL;
	...
	if (comparacion > 0)
		return buscar_elemento_comparando(arbol, nodo_actual->derecha,
						  elemento);

	return buscar_elemento_comparando(arbol, nodo_actual->izquierda,
					  elemento);
}
...
void con_cada_elemento_in_orden(nodo_abb_t *nodo_actual,
				bool (*funcion)(void *, void *), void *aux,
				size_t *i, bool *seguir_recorriendo)
{
	if (!nodo_actual)
		return;

	con_cada_elemento_in_orden(nodo_actual->izquierda, funcion, aux, i,
				   seguir_recorriendo);
	if (*seguir_recorriendo) {
		...
		con_cada_elemento_in_orden(nodo_actual->derecha, funcion, aux,
					   i, seguir_recorriendo);
	}
}

void con_cada_elemento_pre_orden(nodo_abb_t *nodo_actual,
				 bool (*funcion)(void *, void *), void *aux,
				 size_t *i, bool *seguir_recorriendo)
{
	if (!nodo_actual)
	...
	con_cada_elemento_pre_orden(nodo_actual->izquierda, funcion, aux, i,
				    seguir_recorriendo);
	if (*seguir_recorriendo)
		con_cada_elemento_pre_orden(nodo_actual->derecha, funcion, aux,
					    i, seguir_recorriendo);
	return;
}

void con_cada_elemento_post_orden(nodo_abb_t *nodo_actual,
				  bool (*funcion)(void *, void *), void *aux,
				  size_t *i, bool *seguir_recorriendo)
{
	if (!nodo_actual)
	...
	if (*seguir_recorriendo == false)
		return;
	con_cada_elemento_post_orden(nodo_actual->izquierda, funcion, aux, i,
				     seguir_recorriendo);
	if (*seguir_recorriendo == false)
		return;
	con_cada_elemento_post_orden(nodo_actual->derecha, funcion, aux, i,
				     seguir_recorriendo);
	if (*seguir_recorriendo == false)
		return;
	(*i)++;
			     ...
			     bool (*funcion)(void *, void *), void *aux)
{
	...
	if (recorrido == INORDEN)
		con_cada_elemento_in_orden(arbol->nodo_raiz, funcion, aux, &i,
					   &seguir_recorriendo);
	if (recorrido == PREORDEN)
		con_cada_elemento_pre_orden(arbol->nodo_raiz, funcion, aux, &i,
					    &seguir_recorriendo);
	if (recorrido == POSTORDEN)
		con_cada_elemento_post_orden(arbol->nodo_raiz, funcion, aux, &i,
					     &seguir_recorriendo);
...
void recorrido_in_orden(nodo_abb_t *nodo_actual, void **array,
			size_t tamanio_array, size_t *i)
{
	...
	if (*i < tamanio_array)
		recorrido_in_orden(nodo_actual->derecha, array, tamanio_array,
				   i);
}
void recorrido_pre_orden(nodo_abb_t *nodo_actual, void **array,
			 size_t tamanio_array, size_t *i)
{
	if (!nodo_actual)
		return;
	...
	if (*i < tamanio_array)
		recorrido_pre_orden(nodo_actual->derecha, array, tamanio_array,
				    i);
}

void recorrido_post_orden(nodo_abb_t *nodo_actual, void **array,
			  size_t tamanio_array, size_t *i)
{
	if (!nodo_actual)
		return;
	...
	if (*i < tamanio_array)
		recorrido_post_orden(nodo_actual->derecha, array, tamanio_array,
				     i);
	if (*i < tamanio_array)
		guardar_elemento_vector(array, nodo_actual->elemento, i);
}
		    ...
		    size_t tamanio_array)
{
	...
	if (recorrido == POSTORDEN)
		recorrido_post_orden(arbol->nodo_raiz, array, tamanio_array,
				     &i);
