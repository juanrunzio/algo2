...
void insercion_en_hash() {
  ...
  pa2m_afirmar(hash_cantidad(hash_1) == 1,
               "Se agrego un elemento correctamente");
  ...
  pa2m_afirmar(hash_cantidad(hash_1) == 2,
               "Se agrego un segundo elemento correctamente");
  pa2m_afirmar(anterior == NULL,
               "Anterior es NULL ya que no existia anteriormente la clave");
  hash_destruir_todo(hash_1, NULL);
}
void reemplazo_en_hash() {
  ...
  pa2m_afirmar(hash_cantidad(hash_1) == 1,
               "Se agrego un elemento con clave existente");
  pa2m_afirmar(
      anterior == &numero_5,
      "Anterior almacena el puntero al elemento que estaba anteriormente");
  hash_1 = hash_insertar(hash_1, "Andres", &numero_6, &anterior);
  pa2m_afirmar(hash_cantidad(hash_1) == 1,
               "Se agrego de nuevo un elemento con la misma clave");
  pa2m_afirmar(
      anterior == &numero_6,
      "Anterior almacena el puntero al elemento que estaba anteriormente");
  hash_destruir_todo(hash_1, NULL);
...
void insercion_con_clave_anterior_o_hash_null() {
  ...
  void *anterior = NULL;
  int numero_5 = 5;
  pa2m_afirmar(hash_insertar(hash_1, NULL, &numero_5, &anterior) == NULL,
               "No puedo insertar con clave NULL");
  pa2m_afirmar(hash_insertar(NULL, "Andres", &numero_5, &anterior) == NULL,
               "No puedo insertar con hash NULL");
  pa2m_afirmar(hash_insertar(hash_1, "Andres", &numero_5, NULL) != NULL,
...
void elimino_elementos() {
  ...
  pa2m_afirmar(strcmp(resultado, "valor") == 0,
...
void contiene_elementos() {
  ...
  pa2m_afirmar(resultado == true,
               "Encuentra otro elemento distinto y devuelve true");
